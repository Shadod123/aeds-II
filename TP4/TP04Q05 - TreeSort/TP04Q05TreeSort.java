...
/**
 * No da arvore binaria do TreeSort
 */
class No {
...
/** 
 * Arvore binaria de ordenacao (TreeSort)
 */
class TreeSort {
    ...
    /**
	 * Metodo publico iterativo que percorre a estrutura de ordenacao
     * em ordem (caminhamento central) para exibir seus elementos de forma ordenada.
	 */
	...
	/**
	 * Metodo privado recursivo que percorre a estrutura de ordenacao
     * em ordem (caminhamento central) para exibir seus elementos de forma ordenada.
	 * @param i No em analise.
	 */
	private void showInOrder(No i) {
		if (i != null) {
			showInOrder(i.esq); // Elementos da esquerda.
			i.elemento.print();
			showInOrder(i.dir); // Elementos da direita.
		} comp_num++;
	}

	/**
	 * Metodo publico iterativo para exibir os nomes dos elementos
     * em ordem.
	 */
	...
	/**
	 * Metodo privado recursivo para exibir os nomes dos elementos 
     * em ordem.
	 * @param i No em analise.
	 */
...
public class TP04Q05TreeSort {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        Arq.print("738811" + "\t" + TreeSort.comp_num + "\t" + (end-start)/1000.0);
        Arq.close();
    }
}