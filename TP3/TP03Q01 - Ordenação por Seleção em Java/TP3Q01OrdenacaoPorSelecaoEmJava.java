/*----------------------------------------------------------------
Atividade: TP03Q01 - Ordenacao por Selecao em Java
------------------------------------------------------------------
...
class Lista {
    ...
    */
     ...
     * de ordenacao por selecao.
     */
    public void selectionSortCountry(){
        Serie tmp;
        ...
        for (int i = 0; i < (n - 1); i++) {
            ...
            for (int j = (i + 1); j < n; j++){
                if (stringTrim(series[menor].getCountry()).compareTo(stringTrim(series[j].getCountry())) > 0){
                   menor = j;
                } comp_num++;  
            }
...
public class TP3Q01OrdenacaoPorSelecaoEmJava {
