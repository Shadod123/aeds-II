/*----------------------------------------------------------------
Atividade: TP03Q06 - Quicksort em Java
------------------------------------------------------------------
...
class Lista {
    ...
    */
     ...
     */
    private void quickSortCountry(int esq, int dir) {
        int i = esq, j = dir;
        Serie pivo = series[(dir+esq)/2];

        while (i <= j) {
            while ( stringTrim(series[i].getCountry()).compareTo(stringTrim(pivo.getCountry())) < 0 ){
                comp_num++;
                i++;
            } comp_num++;
            while ( stringTrim(series[j].getCountry()).compareTo(stringTrim(pivo.getCountry())) > 0 ){ 
                comp_num++;
                j--;
            } comp_num++;
        ...
        if (esq < j)  quickSortCountry(esq, j);
        if (i < dir)  quickSortCountry(i, dir);
    }
    ...
    public void selectionSortName(){
        ...
        for (int i = 0; i < (n - 1); i++) {
            ...
            if (stringTrim(series[i].getCountry()).equals(stringTrim(series[i+1].getCountry()))) {
                for (int j = (i + 1); j < n && stringTrim(series[menor].getCountry()).equals(stringTrim(series[j].getCountry())); j++) {
...
public class TP3Q06QuicksortEmJava {
