/*----------------------------------------------------------------
Atividade: TP04Q08 - Hash Indireto com Lista Simples
------------------------------------------------------------------
...
class Lista {
    ...
    * @param x elemento Serie a ser inserido.
    ...
    /**
	 * Procura um elemento, pela chave nome, e retorna se ele existe.
	 * @param name chave do elemento a ser pesquisado.
	 * @return <code>true</code> se o elemento existir,
	 * <code>false</code> em caso contrario.
	 */
	public boolean pesquisarByName(String name) {
		boolean resp = false;

		for (Celula i = primeiro.prox; i != null; i = i.prox) {
            if(i.elemento.getName().equals(name)){
                resp = true;
                i = ultimo;
            } comp_num++;
            comp_num++;
...
class HashIndiretoLista {
    ...
    public int h(String name){
        return ASCIIvalueOf(name) % tamanho;
    }
 
    boolean pesquisar(String name){
        int pos = h(name);
        return tabela[pos].pesquisarByName(name);
    }
...
public class TP04Q08HashIndiretoListaSimples {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        HashIndiretoLista hashtable = new HashIndiretoLista();
        ...
        Arq.print("738811" + "\t" + Lista.comp_num + "\t" + (end-start)/1000.0);
        Arq.close(); 
    }
}