/*----------------------------------------------------------------
Atividade: TP02Q04 - Pesquisa Binária em Java
------------------------------------------------------------------
...
class Lista {
    ...
    */
    ...
    /**
     * Procura um elemento, atraves da pesquisa binaria,
     * e retorna se ele existe.
    ...
    public boolean pesqBin(String x){
        ...
        while (esq <= dir){
            meio = (esq + dir) / 2;
            //Contar como se sempre passasse pelo if e else if em cada ciclo
            comp_num = comp_num + 2;
            if (x.equals(series[meio].getName())){
                resp = true;
                esq = dir + 1;        
            } else if (x.compareTo(series[meio].getName()) > 0) {
                esq = meio + 1;
            } else {
                dir = meio - 1;
            }
...
public class TP02Q04PesquisaBinariaEmJava {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0; i < numEntrada2; i++){    
            if(lista.pesqBin(entrada2[i])){
                MyIO.println("SIM");
                //Se a string procurada foi encontrada, no ultimo ciclo do while so'
                //foi feita a comparacao do if, entao, o contador de comparacoes deve
                //ser decrementado de 1, ja' que o numero de comparacoes desse ultimo
                //ciclo foi contabilizado erroneamente como 2
                Lista.comp_num--;
            }
            else{
        ...
        Arq.print("738811" + "\t" + (end-start)/1000.0 + "\t" + Lista.comp_num);
        Arq.close(); 
    }
}