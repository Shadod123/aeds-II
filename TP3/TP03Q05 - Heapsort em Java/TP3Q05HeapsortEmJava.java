/*----------------------------------------------------------------
Atividade: TP03Q05 - Heapsort em Java
------------------------------------------------------------------
...
class Lista {
    ...
    */
     ...
     * anteriormente sobre o atributo format. Reordena, em ordem
     * alfabetica, os items da lista que compartilham do mesmo 
     * valor para o atributo format.
     */
    public void selectionSortName(){
        ...
        for (int i = 0; i < (n - 1); i++) {
            ...
            if (stringTrim(series[i].getFormat()).equals(stringTrim(series[i+1].getFormat()))) {
                for (int j = (i + 1); j < n && stringTrim(series[menor].getFormat()).equals(stringTrim(series[j].getFormat())); j++) {
...
public class TP3Q05HeapsortEmJava {
