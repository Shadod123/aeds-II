/*----------------------------------------------------------------
Atividade: TP04Q06 - Tabela Hash Direta com Reserva em Java
------------------------------------------------------------------
...
public class TP04Q06HashDiretoReserva {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        HashDiretoReserva hashtable = new HashDiretoReserva();
        int numEntrada1 = 0, numEntrada2 = 0;
        double start = 0, end = 0; 
        
        HashDiretoReserva.comp_num = 0;
        start = now();
        ...
        Arq.print("738811" + "\t" + HashDiretoReserva.comp_num + "\t" + (end-start)/1000.0);
        Arq.close(); 
    }
}
