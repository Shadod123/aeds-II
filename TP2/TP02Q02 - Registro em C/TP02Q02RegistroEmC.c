/*----------------------------------------------------------------
Atividade: TP02Q02 - Registro em C
------------------------------------------------------------------
...
#include<stdbool.h>
    ...
    /**
    * clone - Cria uma duplicata do objeto da struct Serie recebido como parametro.
    *
    * entrada(s): serie - objeto a ser clonado
    * 
    * saida: copy - clone/copia do objeto recebido como parametro
    */ 
    Serie clone (Serie serie){
        static Serie copy;
    ...
    */ 
    ...
    int main ( ){
        ...
        char path [150];
        Serie item1;
        //Serie item2 = clone(item1); //Teste do metodo clone
