/*----------------------------------------------------------------
Atividade: TP02Q01 - Classe Serie em Java
------------------------------------------------------------------
...
class TP02Q01ClasseSerieEmJava {
    ...
    public static void main (String[] args){
        ...
        //Serie item2 = item1.clone(); //Teste do metodo clone
        int numEntrada = 0;
        ...
        //Para cada linha de entrada, gerando uma saida com os valores dos atributos de item1, 
        //obtidos por meio da leitura do arquivo .html inserido
