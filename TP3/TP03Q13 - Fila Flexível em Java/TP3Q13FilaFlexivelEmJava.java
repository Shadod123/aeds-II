/*----------------------------------------------------------------
Atividade: TP03Q13 - Fila Flexivel em Java
------------------------------------------------------------------
...
class Fila {
     ...
     * @return boolean indicando se a fila esta cheia
     */
    ...
    /**
     * Calcula e retorna a media arredondada da quantidade 
     * total de temporadas dos elementos da fila
     * @return media arredondada da quantidade total de 
     * temporadas dos elementos da fila 
     */
    public int avgSeasons() {
        int sum = 0;
        int qtd = 0;
        int avg = 0;
        ...
        for(Celula i = primeiro.prox; i != null; i = i.prox) {
            sum = sum + i.elemento.getSeasons();
            qtd++;
        }

        if(qtd != 0){ 
            avg = Math.toIntExact(Math.round(sum / (double) qtd)); 
        } 
...
public class TP3Q13FilaFlexivelEmJava {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0; i < numEntrada; i++){
            ...
            if(filaCirc.isCheia()){
                deleted = filaCirc.remover();
                removidos[numRemovidos] = deleted.getName();
                numRemovidos++;
            }
            filaCirc.inserir(clone);

            MyIO.println(filaCirc.avgSeasons());
        }
        ...
        //Descomentar caso a intencao seja que os elementos removidos
        //e a atual composicao da lista seja exibida na saida 
        /*
