/*----------------------------------------------------------------
Atividade: TP03Q08 - Bolha em Java
------------------------------------------------------------------
...
class Lista {
    ...
    */
     ...
     * anteriormente sobre o atributo seasons. Reordena, em ordem
     * alfabetica, os items da lista que compartilham do mesmo 
     * valor para o atributo seasons.
     */
    public void selectionSortName(){
        ...
        for (int i = 0; i < (n - 1); i++) {
            ...
            if (series[i].getSeasons() == series[i+1].getSeasons()) {
                for (int j = (i + 1); j < n && series[menor].getSeasons() == series[j].getSeasons(); j++) {
...
public class TP3Q08BolhaEmJava {
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        Lista.mov_num = 0;
        start = now();
        lista.bubbleSortSeasons();
        lista.selectionSortName();
        end = now();

        lista.mostrar();
             
        Arq.openWrite("matricula_bolha.txt");
